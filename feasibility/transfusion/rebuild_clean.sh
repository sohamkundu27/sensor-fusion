...
./env2/bin/pip install mmdet==2.11.0 mmsegmentation==0.14.1
./env2/bin/pip install numba==0.48.0 nuscenes-devkit pyquaternion Pillow==8.4.0 tqdm setuptools==59.5.0 ninja
./env2/bin/python -c "import torch,mmcv,mmdet;print('TF ENV2 OK torch',torch.__version__,'mmcv',mmcv.__version__,'mmdet',mmdet.__version__,'cuda',torch.cuda.is_available())"
