...
./env/bin/pip install mmdet==2.11.0 mmsegmentation==0.14.1
./env/bin/pip install numpy==1.23.5 numba==0.48.0 nuscenes-devkit pyquaternion Pillow==8.4.0 tqdm setuptools==59.5.0 ninja
